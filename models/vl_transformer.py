...
#
#     def forward(self, src, src_mask, target, pos_embed):
#         # print(src.shape, pos_embed.shape) # (bs, channel, in_points)
#         src = src.permute(2, 0, 1)
#         pos_embed = pos_embed.permute(2, 0, 1)
#         tgt = target
#         memory = self.encoder(src, src_key_padding_mask=src_mask, pos=pos_embed)
#         hs = self.decoder(tgt, memory, memory_key_padding_mask=src_mask,
#                           pos=pos_embed)
...
class VLTransformer(nn.Module):
    ...
    # sentence as input of the decoder
    # def forward(self, src, src_mask, target, pos_embed):
    #     # print(src.shape, pos_embed.shape) # (bs, channel, in_points)
    #     src = src.permute(2, 0, 1)
    #     pos_embed = pos_embed.permute(2, 0, 1)
    ...
    # # fine-grained text no pos
    # def forward(self, src, src_mask, target, pos_embed, tgt_mask):
    #     # print(src.shape, pos_embed.shape) # (bs, channel, in_points)
    #     src = src.permute(2, 0, 1)
    #     pos_embed = pos_embed.permute(2, 0, 1)
    #     tgt = target
    ...
    def forward(self, src, src_mask, target, pos_embed, tgt_mask, tgt_pos=None):
        # print(src.shape, pos_embed.shape) # (bs, channel, in_points)
        src = src.permute(2, 0, 1)
        pos_embed = pos_embed.permute(2, 0, 1)
        tgt = target
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        # # new, cross attention doesn't use pos
    ...
    def forward_pre(self, tgt, memory,
        ...
        # # new, cross attention doesn't use pos
        # tgt2, attn = self.multihead_attn(query=tgt2,
        #                                  key=memory,
        #                                  value=memory, attn_mask=memory_mask,
        #                                  key_padding_mask=memory_key_padding_mask)
